...
export function SkeletonCard() {
	return (
		<div className='flex-shrink-0'>
			<Skeleton className='w-[250px] h-[330px] group transition-transform duration-500 relative max-w-[250px] overflow-hidden bg-slate-50/5 text-slate-50 border-slate-50/10 cursor-pointer'>
