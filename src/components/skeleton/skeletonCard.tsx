...
export function SkeletonCard() {
	return (
		<div className='flex-shrink-0'>
			<Skeleton className='w-[250px] h-[250px] group transition-transform duration-500 max-w-[200px] relative overflow-hidden bg-slate-50/5 text-slate-50 border-slate-50/10 cursor-pointer'>
